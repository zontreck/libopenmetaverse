...
public static class J2KEncoder
{
    ...
    private static readonly ParameterList pl;
    ...
    public static byte[] EncodeJPEG(AnyBitmap jpgImage)
    {
        Tiler imgtiler;
        ...
        var imgsrc = new ImgReaderGDI(jpgImage);
        ...
        {
            bwriter = new FileCodestreamWriter(stream, int.MaxValue);
