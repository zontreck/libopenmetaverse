...
public class EnumeratedColorSpaceMapper : ColorSpaceMapper
{
    ...
    public override string ToString()
    {
        ...
        var rep_fixedValue = new StringBuilder("fixedPointBits= (");
        var rep_shiftValue = new StringBuilder("shiftValue= (");
        var rep_maxValue = new StringBuilder("maxValue= (");
        ...
        var rep = new StringBuilder("[EnumeratedColorSpaceMapper ");
