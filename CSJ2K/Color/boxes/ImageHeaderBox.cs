...
public sealed class ImageHeaderBox : JP2Box
{
    ...
    {
        var rep = new StringBuilder("[ImageHeaderBox ").Append(eol).Append("  ");
        ...
        rep.Append("image colorspace is ").Append(new StringBuilder(unk ? "known" : "unknown").ToString());
        rep.Append(", the image ").Append(new StringBuilder(ipr ? "contains " : "does not contain ").ToString())
