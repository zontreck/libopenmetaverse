...
{
    private readonly ArrayList map = ArrayList.Synchronized(new ArrayList(10));
    ...
    {
        var rep = new StringBuilder("[ComponentMappingBox ").Append("  ");
        rep.Append("nChannels= ").Append(Convert.ToString(NChannels));
        var Enum = map.GetEnumerator();
