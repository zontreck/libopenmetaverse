...
public sealed class ColorSpecificationBox : JP2Box
{
                ...
                switch (cs)
                {
                    ...
                    case 3:
                        FacilityManager.getMsgLogger().printmsg(MsgLogger_Fields.WARNING,
                            "Unsupported enumerated colorspace YCbCr(2) in color specification box");
                        ColorSpace = Color.ColorSpace.CSEnum.Unknown;
                        break;
                    case 4:
                        FacilityManager.getMsgLogger().printmsg(MsgLogger_Fields.WARNING,
                            "Unsupported enumerated colorspace YCbCr(3) in color specification box");
                        ColorSpace = Color.ColorSpace.CSEnum.Unknown;
                        break;
                    case 9:
                        FacilityManager.getMsgLogger().printmsg(MsgLogger_Fields.WARNING,
                            "Unsupported enumerated colorspace PhotoYCC in color specification box");
                        ColorSpace = Color.ColorSpace.CSEnum.Unknown;
                        break;
                    case 11:
                        FacilityManager.getMsgLogger().printmsg(MsgLogger_Fields.WARNING,
                            "Unsupported enumerated colorspace CMY in color specification box");
                        ColorSpace = Color.ColorSpace.CSEnum.Unknown;
                        break;
                    case 12:
                        FacilityManager.getMsgLogger().printmsg(MsgLogger_Fields.WARNING,
                            "Unsupported enumerated colorspace CMYK in color specification box");
                        ColorSpace = Color.ColorSpace.CSEnum.Unknown;
                        break;
                    case 13:
                        FacilityManager.getMsgLogger().printmsg(MsgLogger_Fields.WARNING,
                            "Unsupported enumerated colorspace YCCK in color specification box");
                        ColorSpace = Color.ColorSpace.CSEnum.Unknown;
                        break;
                    case 14:
                        FacilityManager.getMsgLogger().printmsg(MsgLogger_Fields.WARNING,
                            "Unsupported enumerated colorspace CIELab in color specification box");
                        ColorSpace = Color.ColorSpace.CSEnum.Unknown;
                        break;
                    case 15:
                        FacilityManager.getMsgLogger().printmsg(MsgLogger_Fields.WARNING,
                            "Unsupported enumerated colorspace Bi-Level(2) in color specification box");
                        ColorSpace = Color.ColorSpace.CSEnum.Unknown;
                        break;
                    case 19:
                        FacilityManager.getMsgLogger().printmsg(MsgLogger_Fields.WARNING,
                            "Unsupported enumerated colorspace CIEJab in color specification box");
                        ColorSpace = Color.ColorSpace.CSEnum.Unknown;
                        break;
                    case 21:
                        FacilityManager.getMsgLogger().printmsg(MsgLogger_Fields.WARNING,
                            "Unsupported enumerated colorspace ROMM-RGB in color specification box");
                        ColorSpace = Color.ColorSpace.CSEnum.Unknown;
                        break;
                    case 22:
                        FacilityManager.getMsgLogger().printmsg(MsgLogger_Fields.WARNING,
                            "Unsupported enumerated colorspace YPbPr(1125/60) in color specification box");
                        ColorSpace = Color.ColorSpace.CSEnum.Unknown;
                        break;
                    case 23:
                        FacilityManager.getMsgLogger().printmsg(MsgLogger_Fields.WARNING,
                            "Unsupported enumerated colorspace YPbPr(1250/50) in color specification box");
                        ColorSpace = Color.ColorSpace.CSEnum.Unknown;
                        break;
                    case 24:
                        FacilityManager.getMsgLogger().printmsg(MsgLogger_Fields.WARNING,
                            "Unsupported enumerated colorspace e-sYCC in color specification box");
                        ColorSpace = Color.ColorSpace.CSEnum.Unknown;
                        break;
    ...
    {
        var rep = new StringBuilder("[ColorSpecificationBox ");
