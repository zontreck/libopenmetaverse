...
public class ICCTextDescriptionType : ICCTag
{
    ...
    /// </param>
    protected internal ICCTextDescriptionType(int signature, byte[] data, int offset, int length) : base(signature,
        data, offset, length)
    {
    ...
    {
        return "[" + base.ToString() + " \"" + Encoding.ASCII.GetString(ascii) + "\"]";
    }
