...
public class ICCTextType : ICCTag
{
    ...
    /// </param>
    protected internal ICCTextType(int signature, byte[] data, int offset, int length) : base(signature, data, offset,
        length)
    {
    ...
    {
        return "[" + base.ToString() + " \"" + Encoding.ASCII.GetString(ascii, 0, ascii.Length) + "\"]";
    }
