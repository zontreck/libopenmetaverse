...
internal class EndianBinaryReader : BinaryReader
{
    ...
    public EndianBinaryReader(Stream input, bool bigEndian) : base(input,
        bigEndian ? Encoding.BigEndianUnicode : Encoding.ASCII)
    {
        _bigEndian = bigEndian;
    }
    ...
    public override decimal ReadDecimal()
    {
        if (_bigEndian)
        {
            ...
            var buf = ReadBytes(16);
            Array.Reverse(buf);
            var decimalints = new int[4];
