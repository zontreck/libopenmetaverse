...
internal class SupportClass
{
    ...
    public class Tokenizer : IEnumerator
    {
        ...
        public string NextToken(string delimiters)
        {
            ...
            if (Array.IndexOf(delimiters.ToCharArray(), chars[currentPos]) != -1
                && includeDelims)
    ...
    public class StreamTokenizerSupport
    {
        ...
        {
            var s = "";
            for (var i = reader.Read(); i != -1; i = reader.Read()) s += (char)i;
            reader.Close();
        ...
        {
            inReader = new BackReader(new StreamReader(reader.BaseStream, reader.CurrentEncoding).BaseStream, 2,
        ...
        /// </summary>
        /// <param name="flag">
        ///     True indicates that end-of-line characters are separate tokens; False indicates
        ///     that end-of-line characters are white space.
        /// </param>
