...
public abstract class Subband
{
    ...
    public virtual Subband nextSubband()
    {
        ...
        switch (orientation)
        {
            ...
            case WT_ORIENT_HH:
                ...
                sb = this;
                while (sb.orientation == WT_ORIENT_HH) sb = sb.Parent;
                switch (sb.orientation)
                {
                    ...
                    default:
                        throw new ApplicationException("You have found a bug in JJ2000");
                }
    ...
    public virtual Subband getSubbandByIdx(int rl, int sbi)
    {
        ...
        if (rl > sb.resLvl || rl < 0) throw new ArgumentException("Resolution level index " + "out of range");
    ...
    public virtual Subband getSubband(int x, int y)
    {
        ...
        if (x < ulx || y < uly || x >= ulx + w || y >= uly + h) throw new ArgumentException();
    ...
    {
        var string_Renamed = "w=" + w + ",h=" + h + ",ulx=" + ulx + ",uly=" + uly + ",ulcx=" + ulcx + ",ulcy=" + ulcy +
                             ",idx=" + sbandIdx + ",orient=" + orientation + ",node=" + isNode + ",level=" + level +
                             ",resLvl=" + resLvl + ",nomCBlkW=" + nomCBlkW + ",nomCBlkH=" + nomCBlkH + ",numCb=" +
                             numCb;
