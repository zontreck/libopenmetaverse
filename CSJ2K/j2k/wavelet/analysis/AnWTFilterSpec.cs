...
public class AnWTFilterSpec : ModuleSpec
{
            ...
            switch (word[0])
            {
                ...
                case 'W': // WT filters specification
                    if (pl.getBooleanParameter("lossless") && word.ToUpper().Equals("w9x7".ToUpper()))
                        throw new ArgumentException("Cannot use non " + "reversible " + "wavelet transform with" +
                                                    " '-lossless' option");
        ...
        for (var c = nc - 1; c >= 0; c--)
            ...
            if (((string)qts.getTileCompVal(t, c)).Equals("reversible"))
            {
                ...
                if (!isFilterSpecified)
                    ...
                    throw new ArgumentException("Filter of " + "tile-component" + " (" + t + "," + c + ") does" +
                                                " not allow " + "reversible " + "quantization. " + "Specify '-Qtype " +
            ...
            else
            {
                ...
                if (!isFilterSpecified)
                    ...
                    throw new ArgumentException("Filter of " + "tile-component" + " (" + t + "," + c + ") does" +
                                                " not allow " + "non-reversible " + "quantization. " +
                                                "Specify '-Qtype " + "reversible' in " + "the command line");
            }
    }
    ...
    private AnWTFilter[][] parseFilters(string word)
    {
        ...
        for (var i = 0; i < 2; i++) filt[i] = new AnWTFilter[1];
