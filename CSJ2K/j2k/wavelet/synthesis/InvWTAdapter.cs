...
public abstract class InvWTAdapter : InvWT
{
    ...
    public virtual int ImgResLevel
    {
        set
        {
            if (value < 0) throw new ArgumentException("Resolution level index " + "cannot be negative.");
            reslvl = value;
        }
    }
    ...
    /// </param>
    /// <returns>
    ///     The width in pixels of component <tt>n</tt> in tile <tt>t</tt>.
    /// </returns>
    ...
    /// </param>
    /// <returns>
    ///     The height in pixels of component <tt>n</tt> in tile
    ///     <tt>t</tt>.
    /// </returns>
