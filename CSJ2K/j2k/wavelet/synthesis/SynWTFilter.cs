...
public abstract class SynWTFilter : WaveletFilter
{
    ...
    /// </param>
    public abstract void synthetize_lpf(object lowSig, int lowOff, int lowLen, int lowStep, object highSig, int highOff,
    ...
    ///     samples in the outSig array. See above.
    /// </param>
    public abstract void synthetize_hpf(object lowSig, int lowOff, int lowLen, int lowStep, object highSig, int highOff,
        int highLen, int highStep, object outSig, int outOff, int outStep);
}