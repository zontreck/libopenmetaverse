...
public class BEBufferedRandomAccessFile : BufferedRandomAccessFile, RandomAccessIO, EndianType
{
    ...
    public override long readLong()
    {
        ...
        return (long)(((ulong)read() << 56) | ((ulong)read() << 48) | ((ulong)read() << 40) | ((ulong)read() << 32) |
    ...
    public override float readFloat()
    {
        ...
        return BitConverter.ToSingle(BitConverter.GetBytes((read() << 24) | (read() << 16) | (read() << 8) | read()),
            0);
    }
    ...
    public override double readDouble()
    {
        ...
        return BitConverter.ToDouble(
            BitConverter.GetBytes(((long)read() << 56) | ((long)read() << 48) | ((long)read() << 40) |
