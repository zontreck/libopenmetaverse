...
public abstract class ImgReader : BlkImgDataSrc
{
    ...
    {
        if (t != 0)
            throw new ApplicationException("Asking a tile-component width for a tile index" +
    ...
    public abstract DataBlk getInternCompData(DataBlk param1, int param2);
    public abstract int getNomRangeBits(int param1);
    public abstract DataBlk getCompData(DataBlk param1, int param2);
