...
public class PrecinctSizeSpec : ModuleSpec
{
        ...
        base(nt, nc, type)
    {
        ...
        var tmpv = new ArrayList[2];
        tmpv[0] = ArrayList.Synchronized(new ArrayList(10)); // ppx
        tmpv[0].Add(Markers.PRECINCT_PARTITION_DEF_SIZE);
        tmpv[1] = ArrayList.Synchronized(new ArrayList(10)); // ppy
        tmpv[1].Add(Markers.PRECINCT_PARTITION_DEF_SIZE);
        setDefault(tmpv);
        ...
        {
            var v = new ArrayList[2]; // v[0] : ppx, v[1] : ppy
            ...
            if (!wasReadingPrecinctSize) word = stk.NextToken();
            ...
            switch (word[0])
            {
                ...
                default:
                    ...
                    v[0] = ArrayList.Synchronized(new ArrayList(10)); // ppx
                    v[1] = ArrayList.Synchronized(new ArrayList(10)); // ppy
                    ...
                    while (true)
                    {
                        ...
                        else
                        {
                            ...
                            if (curSpecType == SPEC_DEF)
                                ...
                                for (ti = tileSpec.Length - 1; ti >= 0; ti--)
                                {
                                    if (tileSpec[ti]) setTileDef(ti, v);
                                }
                            else if (curSpecType == SPEC_COMP_DEF)
                                for (ci = compSpec.Length - 1; ci >= 0; ci--)
                                {
