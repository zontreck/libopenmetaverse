            ...
            switch (word[0])
            {
                ...
                default:
                    ...
                    try
                    {
                        ...
                        {
                            errMsg = "'" + optName + "' option : the code-block's " + "width cannot be greater than " +
                                     StdEntropyCoderOptions.MAX_CB_DIM;
                            throw new ArgumentException(errMsg);
                        }
                        ...
                        {
                            errMsg = "'" + optName + "' option : the code-block's " + "width cannot be less than " +
                                     StdEntropyCoderOptions.MIN_CB_DIM;
                            throw new ArgumentException(errMsg);
                        }
                    ...
                    try
                    {
                        ...
                        {
                            errMsg = "'" + optName + "' option : the code-block's " + "height cannot be greater than " +
                                     StdEntropyCoderOptions.MAX_CB_DIM;
                            throw new ArgumentException(errMsg);
                        }
                        ...
                        {
                            errMsg = "'" + optName + "' option : the code-block's " + "height cannot be less than " +
                                     StdEntropyCoderOptions.MIN_CB_DIM;
                            throw new ArgumentException(errMsg);
                        }
                        ...
                        {
                            errMsg = "'" + optName + "' option : The " + "code-block's area (i.e. width*height) " +
                    ...
                    if (dim[0] > maxCBlkWidth) maxCBlkWidth = dim[0];

                    if (dim[1] > maxCBlkHeight) maxCBlkHeight = dim[1];
