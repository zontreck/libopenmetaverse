...
public class ProgressionSpec : ModuleSpec
{
	...
	public ProgressionSpec(int nt, int nc, int nl, IntegerSpec dls, byte type, ParameterList pl) : base(nt, nc, type)
    {
        ...
        var progression = ArrayList.Synchronized(new ArrayList(10));
        var tmp = 0;
                ...
                default:
                    ...
                    if (needInteger)
                    {
                        ...
                        catch (FormatException)
                        {
                            ...
                            throw new ArgumentException("Progression " + "order" + " specification " + "has missing " +
                                                        "parameters: " + param);
                        }
                        ...
                        switch (intType)
                        {
                            case 0: // cs
                                if (tmp < 0 || tmp > dls.Max + 1)
                                    throw new ArgumentException("Invalid res_start " + "in '-Aptype'" + " option: " +
                                                                tmp);
                                curProg.rs = tmp;
                                break;
                            ...
                            case 1: // rs
                                if (tmp < 0 || tmp > nc)
                                    throw new ArgumentException("Invalid comp_start " + "in '-Aptype' " + "option: " +
                                                                tmp);
                                curProg.cs = tmp;
                                break;
                            ...
                            case 2: // lye
                                if (tmp < 0)
                                    throw new ArgumentException("Invalid layer_end " + "in '-Aptype'" + " option: " +
                                                                tmp);
                                if (tmp > nl) tmp = nl;
                                curProg.lye = tmp;
                                break;
                            ...
                            case 3: // ce
                                if (tmp < 0)
                                    throw new ArgumentException("Invalid res_end " + "in '-Aptype'" + " option: " +
                                                                tmp);
                                if (tmp > dls.Max + 1) tmp = dls.Max + 1;
                                curProg.re = tmp;
                                break;
                            ...
                            case 4: // re
                                if (tmp < 0)
                                    throw new ArgumentException(
                                        "Invalid comp_end " + "in '-Aptype'" + " option: " + tmp);
                                if (tmp > nc) tmp = nc;
                                curProg.ce = tmp;
                                break;
                        }
                        ...
                        throw new ApplicationException("Error in usage of 'Aptype' " + "option: " + param);
                    }
