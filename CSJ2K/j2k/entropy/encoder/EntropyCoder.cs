...
public abstract class EntropyCoder : ImgDataAdapter, CodedCBlkDataSrcEnc
{
    ...
    private static readonly string[][] pinfo =
    {
        new[]
        {
            "Cblksiz", "[<tile-component idx>] <width> <height> " + "[[<tile-component idx>] <width> <height>]",
        ...
        new[]
        {
            ...
            "termination algorithm, see the 'Cterm_type' option." + "'on' enables, 'off' disables it.",
            "off"
        },
        new[]
        {
            ...
            "reset after each arithmetically coded (i.e. non-lazy) coding pass. " + "'on' enables, 'off' disables it.",
            "off"
        },
        new[]
        {
            "Cterminate", "[<tile-component idx>] on|off" + "[ [<tile-component idx>] on|off ...]",
            ...
            "to use an efficient termination algorithm, see the 'Cterm' option. " + "'on' enables, 'off' disables it.",
            "off"
        },
        new[]
        {
            ...
            "next stripe (i.e. the one below it). 'on' " + "enables, 'off' disables it.",
            "off"
        },
        new[]
        {
            ...
            "conceal errors.'on' enables, 'off' disables " + "it.",
            "off"
        },
        new[]
        {
        ...
        new[]
        {
            "Clen_calc", "[<tile-component idx>] near_opt|lazy_good|lazy" + "[ [<tile-component idx>] ...]",
        ...
        new[]
        {
            "Cpp", "[<tile-component idx>] <dim> <dim> [<dim> <dim>] " + "[ [<tile-component idx>] ...]",
