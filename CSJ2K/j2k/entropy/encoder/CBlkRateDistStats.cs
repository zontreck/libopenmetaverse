...
public class CBlkRateDistStats : CodedCBlk
{
    ...
    /// </param>
    public CBlkRateDistStats(int m, int n, int skipMSBP, byte[] data, int[] rates, double[] dists, bool[] termp, int np,
        bool inclast) : base(m, n, skipMSBP, data)
    {
    ...
    public virtual void selectConvexHull(int[] rates, double[] dists, bool[] termp, int n, bool inclast)
    {
        ...
        first_pnt = 0;
        while (first_pnt < n && rates[first_pnt] <= 0) first_pnt++;
    ...
    public override string ToString()
    {
        var str = base.ToString() + "\n nVldTrunc=" + nVldTrunc + ", nTotTrunc=" + nTotTrunc + ", num. ROI" +
                  " coeff=" + nROIcoeff + ", num. ROI coding passes=" + nROIcp + ", sb=" + sb.sbandIdx;
        //          str += "\n\ttruncRates:\n";
