...
public struct StdEntropyCoderOptions
{
	...
	/// </summary>
	public static readonly int OPT_RESET_MQ = 1 << 1;
	...
	/// </summary>
	public static readonly int OPT_TERM_PASS = 1 << 2;

	/// <summary>
	///     The flag bit to indicate the vertically stripe-causal context
	///     formation should be used.
	/// </summary>
	public static readonly int OPT_VERT_STR_CAUSAL = 1 << 3;
	...
	/// </summary>
	public static readonly int OPT_PRED_TERM = 1 << 4;
	...
	///     D.5 of FDIS).
	/// </summary>
	public static readonly int OPT_SEG_SYMBOLS = 1 << 5;
	...
	/// </summary>
	public static readonly int MAX_CB_DIM = 1024;
	...
	/// </summary>
	public static readonly int MAX_CB_AREA = 4096;
