...
public class HeaderInfo : FilterTypes, ICloneable
{
    ...
    /// </summary>
    public Hashtable pocValue = Hashtable.Synchronized(new Hashtable());
    ...
    ///     "t"+tileIdx+"_c"+component_index.
    /// </summary>
    public Hashtable qccValue = Hashtable.Synchronized(new Hashtable());

    /// <summary>
    ///     Reference to the QCD marker segments found in main and first tile-part
    ///     header. The key is either "main" or "t"+tileIdx.
    /// </summary>
    public Hashtable qcdValue = Hashtable.Synchronized(new Hashtable());
    ...
    ///     "t"+tileIdx+"_c"+component_index.
    /// </summary>
    public Hashtable rgnValue = Hashtable.Synchronized(new Hashtable());
    ...
    public virtual string toStringMainHeader()
    {
        ...
        var str = "" + sizValue;
        // COD
        if (codValue["main"] != null) str += "" + (COD)codValue["main"];
        // COCs
        for (var c = 0; c < nc; c++)
            if (cocValue["main_c" + c] != null)
                str += "" + (COC)cocValue["main_c" + c];
        // QCD
        if (qcdValue["main"] != null) str += "" + (QCD)qcdValue["main"];
        // QCCs
        for (var c = 0; c < nc; c++)
        ...
        // POC
        if (pocValue["main"] != null) str += "" + (POC)pocValue["main"];
        // CRG
        if (crgValue != null) str += "" + crgValue;
        // COM
    ...
    public virtual string toStringTileHeader(int t, int ntp)
    {
        ...
        // COD
        if (codValue["t" + t] != null) str += "" + (COD)codValue["t" + t];
        // COCs
        for (var c = 0; c < nc; c++)
            if (cocValue["t" + t + "_c" + c] != null)
                str += "" + (COC)cocValue["t" + t + "_c" + c];
        // QCD
        if (qcdValue["t" + t] != null) str += "" + (QCD)qcdValue["t" + t];
        // QCCs
        for (var c = 0; c < nc; c++)
        ...
        // POC
        if (pocValue["t" + t] != null) str += "" + (POC)pocValue["t" + t];
        return str;
    }
    ...
    public virtual HeaderInfo getCopy(int nt)
    {
        ...
        {
            throw new ApplicationException("Cannot clone HeaderInfo instance");
        }
    ...
    public class SIZ : ICloneable
    {
            ...
            get
            {
                if (compWidth == null)
                {
                    ...
                    for (var cc = 0; cc < csiz; cc++)
                        ...
                        compWidth[cc] = (int)(Math.Ceiling(xsiz / (double)xrsiz[cc]) -
        ...
        public virtual int MaxCompHeight
        {
            get
            {
                if (compHeight == null)
                {
                    ...
                    for (var cc = 0; cc < csiz; cc++)
                        //UPGRADE_WARNING: Data types in Visual C# might be different.  Verify the accuracy of narrowing conversions. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1042'"
                        compHeight[cc] = (int)(Math.Ceiling(ysiz / (double)yrsiz[cc]) -
        ...
        public virtual SIZ Copy
        {
            get
            {
                ...
                {
                    throw new ApplicationException("Cannot clone SIZ marker segment");
                }
        ...
        public override string ToString()
        {
            ...
            str += " Orig. depth  : ";
            for (var i = 0; i < csiz; i++) str += getOrigBitDepth(i) + " ";
            str += "\n";
            str += " Orig. signed : ";
            for (var i = 0; i < csiz; i++) str += isOrigSigned(i) + " ";
            str += "\n";
            str += " Subs. factor : ";
            for (var i = 0; i < csiz; i++) str += xrsiz[i] + "," + yrsiz[i] + " ";
            str += "\n";
            return str;
        }
    }
    ...
    public class COD : ICloneable
    {
        ...
        public override string ToString()
        {
            ...
            {
                str += " Precincts      : ";
                for (var i = 0; i < spcod_ps.Length; i++)
    ...
    public class COC
    {
        ...
        public override string ToString()
        {
            ...
            {
                str += " Precincts      : ";
                for (var i = 0; i < spcoc_ps.Length; i++)
    ...
    public class QCD
    {
        ...
        public virtual int QuantType
        {
            get
            {
                if (qType == -1) qType = sqcd & ~ (Markers.SQCX_GB_MSK << Markers.SQCX_GB_SHIFT);
                return qType;
            }
        }
        ...
        public virtual int NumGuardBits
        {
            get
            {
                if (gb == -1) gb = (sqcd >> Markers.SQCX_GB_SHIFT) & Markers.SQCX_GB_MSK;
                return gb;
            }
        }
    ...
    public class QCC
    {
        ...
        public virtual int QuantType
        {
            get
            {
                if (qType == -1) qType = sqcc & ~ (Markers.SQCX_GB_MSK << Markers.SQCX_GB_SHIFT);
                return qType;
            }
        }
        ...
        public virtual int NumGuardBits
        {
            get
            {
                if (gb == -1) gb = (sqcc >> Markers.SQCX_GB_SHIFT) & Markers.SQCX_GB_MSK;
                return gb;
            }
        }
    ...
    public class POC
    {
        ...
        public override string ToString()
        {
            ...
            {
                str += "   " + chg + "      " + rspoc[chg] + "     " + cspoc[chg] + "     " + lyepoc[chg] + "      " +
                       repoc[chg] + "     " + cepoc[chg];
                switch (ppoc[chg])
                {
                    case ProgressionType.LY_RES_COMP_POS_PROG:
    ...
    public class COM
    {
        ...
        public override string ToString()
        {
            ...
            else if (rcom == 1)
            {
                ...
                str += " Text         : " + Encoding.ASCII.GetString(ccom) + "\n";
            }
            else
            {
