...
/// </seealso>
public class DecoderSpecs : ICloneable
{
    ...
    public virtual DecoderSpecs Copy
    {
        get
        {
            ...
            {
                throw new ApplicationException("Cannot clone the DecoderSpecs instance");
            }
            ...
            // ROI
            if (rois != null) decSpec2.rois = (MaxShiftSpec)rois.Copy;
            return decSpec2;
        }
    }
